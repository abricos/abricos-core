...
}, 'release-v3.14.0', {"requires": ["get", "features"]});
...
}, 'release-v3.14.0', {"requires": ["loader-base"]});
...
YUI.add('loader', function (Y, NAME) {}, 'release-v3.14.0', {"use": ["loader-base", "loader-rollup", "loader-yui3"]});
