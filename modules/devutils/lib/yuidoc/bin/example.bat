...
SET yuidoc_home="c:\web\yuidoc\yuidoc"
...
SET parser_in="c:\web\home\cms\www\modules\example\js"
...
SET parser_out="c:\web\yuidoc\docs\parser"

REM The directory to put the html file outputted by the generator
SET generator_out="c:\web\yuidoc\docs\generator"
