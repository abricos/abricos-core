...
class Ab_UserText {
    ...
    public function JevixConfigure($fullerase = false){
        ...
        if (!$fullerase){
            ...
            $jevix->cfgAllowTagParams('object', array(
                'width' => '#int',
                'height' => '#int',
                'data' => array(
                    '#domain' => array(
            ...
            $jevix->cfgAllowTagParams('param', array(
                'name' => '#text',
                'value' => '#text'
            ));
            ...
            $jevix->cfgAllowTagParams('td', array(
                'colspan' => '#int',
                'rowspan' => '#int',
                'align' => array(
                    'right',
            ...
            $jevix->cfgAllowTagParams('table', array(
                'border' => '#int',
                'cellpadding' => '#int',
                'cellspacing' => '#int',
                'align' => array(
            ...
            $jevix->cfgAllowTagParams('pre', array(
                'class' => '#text',
                'value' => '#text'
            ));
            $jevix->cfgAllowTagParams('code', array(
                'class' => '#text',
                'value' => '#text'
            ));
            ...
            $jevix->cfgSetTagChilds('tr', array(
                'td',
                'th'
            ), false, true);
            ...
            $jevix->cfgSetTagNoTypography(array(
                'code',
                'video',
                'object'
            ));

            $jevix->cfgSetLinkProtocolAllow(array(
                'http',
                'https',
                'ftp'
            ));
            ...
            $jevix->cfgSetTagBlockType(array(
                'h4',
                'h5',
                'h6',
                'ol',
